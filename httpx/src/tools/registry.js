 ...
 */
const request = require('./httpx-request');
const download = require('./httpx-download');
const head = require('./httpx-head');
const batch = require('./httpx-batch');
const json = require('./httpx-json');
const probe = require('./httpx-probe');

const TOOLS = [request, download, head, batch, json, probe];
