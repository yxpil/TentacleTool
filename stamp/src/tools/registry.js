...
const now = require('./stamp-now');
const convert = require('./stamp-convert');
const duration = require('./stamp-duration');
const zone = require('./stamp-zone');
const workday = require('./stamp-workday');
const cron = require('./stamp-cron');

const TOOLS = [now, convert, duration, zone, workday, cron];
