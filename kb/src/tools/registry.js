...
const sources = require('./kb-sources');
const schema = require('./kb-schema');
const search = require('./kb-search');
const query = require('./kb-query');
const stats = require('./kb-stats');
const config = require('./kb-config');

const TOOLS = [sources, schema, search, query, stats, config];
