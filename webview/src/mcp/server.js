...
class McpStreamableHttpServer {
  constructor(options = {}) {
    ...
    this.serverName = options.serverName || 'webview-mcp';
    this.serverVersion = options.serverVersion || '1.0.0';
    this.instructions = options.instructions || 'WebView 网页转 Markdown 工具集：网页转 MD、HTML 转 MD、链接提取、元信息提取';
  ...
  start() {
    return new Promise((resolve, reject) => {
      ...
      this.httpServer.listen(this.port, this.host, () => {
        ...
        console.log('==============================================');
        console.log('  WebView MCP Server (网页转 Markdown)');
        console.log('----------------------------------------------');
